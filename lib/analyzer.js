...
const format = (ns, {
    ...
    hackDifficulty
        ...
        securityPercent: `${bar(securityPercent)}${ns.formatPercent(securityPercent).padStart(7, '0')}${colour.reset}`,
        ...
        fundPercent: `${bar(fundPercent)}${ns.formatPercent(fundPercent).padStart(7, '0')}${colour.reset}`,
        fundBar: `${bar(fundPercent)}${drawProgress(fundPercent)}${colour.reset}`,

        levelDifficulty: `${difficulty(levelDifficulty)}${ns.formatPercent(levelDifficulty).padStart(7, '0')}${colour.reset}`,
        securityDifficulty: `${difficulty(securityDifficulty)}${ns.formatPercent(securityDifficulty).padStart(7, '0')}${colour.reset}`,
        fundDifficulty: `${difficulty(fundDifficulty)}${ns.formatPercent(fundDifficulty).padStart(7, '0')}${colour.reset}`,
        hackDifficulty: `${difficulty(hackDifficulty)}${ns.formatPercent(hackDifficulty).padStart(7, '0')}${colour.reset}`
});
